                ...
                <div class="inputs">
                    <div class="row mb-2">
                        <div class="col col-lg-6 col-sm-12 col-12">
                            <input class="p-2 form-control" type="text" name="nom" placeholder="Nom*" value="{{ old('nom') }}">
                            @error('nom')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="col col-lg-6 col-sm-12 col-12">
                            <input class="p-2 form-control" type="text" name="prenom" placeholder="Prenom*" value="{{ old('prenom') }}">
                            @error('prenom')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="row mb-2">
                        <div class="col col-lg-6 col-sm-12 col-12">
                            <input class="form-control p-2" type="password" name="password" placeholder="Mot de passe*" value="{{ old('password') }}">
                            @error('password')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="col col-lg-6 col-sm-12 col-12">
                            <input class="form-control p-2" type="password" name="password_confirmation" placeholder="Confirmation de mot de passe*" value="{{ old('password_confirmation') }}">
                    ...
                    <div class="row mb-2">
                        <div class="col col-lg-12 col-sm-12 col-12">
                            <select class="form-control p-2" name="filier">
                                ...
                                <option value="{{ $filier->id }}" {{ old('formation') == $filier->id ? 'selected' : '' }}>{{$filier->filier}}</option>
                                @endforeach
