                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="specialites" name="specialites"
                            placeholder="DEV, RESEAU" disabled>
                    </div>
                    <div class="col-md-6">
                        <label for="matieres" class="form-label">Matières enseignées</label>
                        <input type="text" class="form-control" id="matieres" name="matieres" disabled
                            placeholder="PHP, VB, HTML, CSS">
                    </div>
                </div>
                ...
                <form>
                    <table class="table dev table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><input type="text" class="form-control" name="matiere[]" placeholder="JAVA" disabled>
                                </td>
                                <td><input type="number" class="form-control" name="note[]" step="0.01"
                                        placeholder="Note"></td>
                            </tr>
                            ...
                            <tr>
                                <td><input type="text" class="form-control" name="nom_etudiant[]"
                                        placeholder="Elguarhi Mohammed Amine" disabled></td>
                                <td><input type="text" class="form-control" name="matiere[]" placeholder="CSS"
                                        disabled></td>
                                <td><input type="number" class="form-control" name="note[]" step="0.01"
                                        placeholder="Note"></td>
                            </tr>
                    ...
                    <table class="table reseau table-bordered">
                        ...
                        <tbody>
                            <tr>
                                <td><input type="text" class="form-control" name="nom_etudiant[]"
                                        placeholder="Nom de l'étudiant" disabled></td>
                                <td><input type="text" class="form-control" name="matiere[]"
                                        placeholder="PACKET TRACER" disabled></td>
                                <td><input type="number" class="form-control" name="note[]" step="0.01"
                                        placeholder="Note"></td>
                            </tr>
                            ...
                            <tr>
                                <td><input type="text" class="form-control" name="nom_etudiant[]"
                                        placeholder="Nom de l'étudiant" disabled></td>
                                <td><input type="text" class="form-control" name="matiere[]" placeholder="JAVA"
                                        disabled></td>
                                <td><input type="number" class="form-control" name="note[]" step="0.01"
                                        placeholder="Note"></td>
                            </tr>
                            ...
                            <tr>
                                <td><input type="text" class="form-control" name="nom_etudiant[]"
                                        placeholder="Nom de l'étudiant" disabled></td>
                                <td><input type="text" class="form-control" name="matiere[]"
                                        placeholder="CYBER SECURITY" disabled></td>
                                <td><input type="number" class="form-control" name="note[]" step="0.01"
                                        placeholder="Note"></td>
                            </tr>
