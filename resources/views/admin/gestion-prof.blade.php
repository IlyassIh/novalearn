...
@section('css') <link rel="stylesheet" href="/css/adminCss/gestion-prof.css"> @endsection
@section('admin-prof') clicked @endsection
@section('js') <script src="/js/admin-prof.js"></script> @endsection
