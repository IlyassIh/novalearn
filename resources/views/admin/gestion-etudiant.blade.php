...
@section('css') <link rel="stylesheet" href="/css/adminCss/gestion-etudiant.css"> @endsection
@section('admin-etudiant') clicked @endsection
@section('js') <script src="/js/admin.js"></script> @endsection
